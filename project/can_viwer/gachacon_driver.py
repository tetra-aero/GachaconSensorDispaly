...
def mode_supplying_intermediate():
    None

def mode_supplying():
    None

def mode_flying_supply_precharge():
    None

def mode_flying_supply_intermediate():
    None

def mode_flying_supply_only():
    None

def mode_flying_esc_precharge():
    None

def mode_flying_esc_intermediate():
    None

def mode_flying():
    None

def mode_discharge_precharge():
    None

def mode_discharge_intermediate():
    None
